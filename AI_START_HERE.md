...
- 작업 시작 시 현재 브랜치·작업 트리·원격 main을 확인합니다. v3 구현은 `codex/v3-release`에서 시작했습니다.
...
- 기존 경로·카메라 엔진을 유지합니다. 제품 UI는 v2의 색상·배치·반투명 패널을 계승합니다. 전면 재설계를 반복하지 않습니다. 도움말/사진 목록만 공통 Dialog를 사용합니다.
