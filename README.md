...
추천 여행은 한 줄 선택 상자에서 고릅니다. 설정 이름의 도움말은 마우스·터치·키보드를 지원합니다. UI는 번들에 포함된 Noto Sans KR Variable과 직관적인 컬러 이동 이모지를 사용하며 폰트 CDN에 접속하지 않습니다. 화면 분할의 기준은 React와 CSS 모두 820px이며, 가로로 짧은 창에서도 재생바와 자막이 화면 안에 유지됩니다.
