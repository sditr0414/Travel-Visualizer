...
전체 화면 지도에서 이동 경로를 따라갑니다. 이동수단 이모지와 함께 날짜·시각, 속도, 해당 이동 구간의 거리를 확인할 수 있습니다. 지나온 경로의 꼬리는 연하게 표시해 현재 위치가 더 잘 보입니다. 일시정지해도 현재 장면을 유지하며, 전체 경로를 함께 보고 싶으면 여행 설정에서 켤 수 있습니다.
...
현재 PC에서 실제 일본 여행 기록과 사진으로 촬영한 영상입니다. 각각 약 30초이며 60fps·무음으로 저장했습니다.
...
GIF는 각 영상의 8초·12fps 미리보기입니다. 부드러운 60fps 전체 영상은 각 링크에서 볼 수 있습니다. [촬영 자료 안내](docs/MEDIA.md)
